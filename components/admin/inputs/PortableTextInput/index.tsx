          ...
          <div className="bg-zinc-900 rounded-xl border border-zinc-700 p-6 w-full max-w-md mx-4">
            ...
            {!pendingImageAssetId ? (
              <button
                ...
                disabled={isUploading}
                className={`w-full border-2 border-dashed border-zinc-600 rounded-lg p-8 text-center cusror-pointer hover:border-zinc-500 transition-colors bg-transparent ${
