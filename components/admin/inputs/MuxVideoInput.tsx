              ...
              style={
                {
                  ...
                  "--uploader-border-color": "#7c3aed",
                  "--button-background-color": "#6d28d9",
                  "--button-hover-background-color": "#5b21b6",
                  "--button-active-background-color": "#7c3aed",
                  "--progress-bar-fill-color": "#7c3aed",
                  "--overlay-background-color": "rbga(0, 0, 0, 0.7)"
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-lg border border-zinc-700 bg-zinc-800/30 p-6">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="font-medium text-white">Procesing video...</p>
