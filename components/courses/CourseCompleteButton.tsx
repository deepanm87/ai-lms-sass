...
import { toggleCourseCompletion } from "@/lib/actions/courses"
...
export function CourseCompleteButton({
  ...
  if (isCompleted) {
    return (
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
