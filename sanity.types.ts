...
export type AllSanitySchemaTypes = Note | Module | Lesson | SanityImageCrop | SanityImageHotspot | MuxVideo | Slug | Course | Category | MuxVideoAsset | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
