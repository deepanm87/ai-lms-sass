...
export const courseType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      validation: Rule => [ 
        Rule.required().error("Description helps students understand the course"),
    ...
    defineField({
      ...
      type: "image",
      group: "details",
      description: "Course thumbnail image (16:9 ratio recommended.) If not provided, a placeholder will be shown.",
      options: {
        hotspot: true
      }
    }),
    defineField({
      ...
      validation: Rule => [ Rule.required().error("Category helps students find your course")]
    }),
    defineField({
      name: "tier",
      type: "string",
