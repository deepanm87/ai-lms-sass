      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Join Deep&apos;s Academy and learn from expertly crafted courses,
              ...
              {isSignedIn ? (
                <>
                  <Link href="/dashboard">
                    <Button
                      size="lg"
                      className="bg-linear-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 to-fuchsia-500 text-white border-0 shadow-xl shadow-violet-600/30 px-8 h-12 text-base font-semibold"
                    >
                ...
                <>
                  <Link href="/pricing">
                    ...
                    >
                      <Play className="w-4 h-r mr-2 fill-white" />
                      Start Learning Free
                    </Button>
                  </Link>
                  <Link href="/dashboard">
        ...
        <section className="px-6 lg:px-12 py-20 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-linear-to-r from-violet-500 to-fuchsia-500 text-xs font-semibold">
                    Most Popular
                  </div>
                )}
                <div className={`w-12 h-12 rounded-xl bg-linear-to-br ${plan.gradient} flex items-center justify-center mb-4 shadow-lg`}>
        ...
        <section
          id="courses" className="px-6 lg:px-12 py-20 max-w-7xl mx-auto"
        >
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              Each course is packed with modules and lessons designed to take you from zero to job-ready.
            </p>
          </div>
            ...
            {[
              {
                ...
                content: "Deep's teaching style is incredible. I went from knowing nothing to landing my first dev job in 6 months!",
                avatar: "🧑‍💻"
              },
              {
                name: "Sarah Miller",
              ...
              },
              {
                name: "James Wilson",
                role: "CS Student",
                content: "Best investment I've made. The pro courses filled gapsp my university courses never covered.",
                avatar: "🎓"
              }
            ].map(testimonial => (
              <div
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold">Deep&apos;s Academy</span>
            </div>
            ...
            <p className="text-sm text-zinc-600">
              © {new Date().getFullYear()} Deep&apos;s Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
