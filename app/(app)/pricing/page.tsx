  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white overflow-hidden">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[600px] bg-violet-600/15 rounded-full blur-[120px] animate-pulse" />
        <div 
      ...
      <main className="relative z-10 px-6 lg:px-12 py-12 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
            ...
            content or go Ultra for AI-powered learning, exclusive masterclass, and 1-on-1 access.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {TIER_FEATURES.map(plan => {
            ...
            return (
              <div
                key={plan.tier}
                className={`p-6 rounded-xl font-bold mb-4 ${colorClasses.text}`}
              > 
                ...
                <ul className="space-y-3">
                  {plan.features.map(feature => (
                    ...
                    >
                      <CheckCircle2 className={`w-4 h-4 mt-0.5 shrink-0 ${colorClasses.text}`} />
                      {feature}
                    </li>
                  ))}
                </ul>
